...
def augmented_rules(i, relations, relation_dic, rules, sc_min, sc_max, head_coverage_threshold, support_threshold,
    ...
    # Data preparation
    X, Y, numerator, denominator, attributehead, headmatching = match(cur_rule, relations, relation_dic, attributes,
                                                                      attribite_dic, attribute_mapping_dic)
    # print(numerator, denominator, np.array(X).shape)
...
if __name__ == '__main__':
    ...
    # Asynchronous parallel computing2
    T1 = time.time()
