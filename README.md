...
### Sample output:
108	21	0.19444444444444445	uncle(X,Y) <= uncle(X,A), brother(A,B), brother(Y,B)	710	uncle	698	0.9538461538461539\
Where the first four columns show the information about the original rule, the fifth to seven columns indicate the new fact inferred from attribute rule and the last column is the new SC of attribute rule.
## Step 3: Predicting
### Command:
